...
export const Multiplebars = [
  {
    ...
    title:
      'Include multiple progress bars in a progress component if you need to apply a stripe via CSS gradient over</span><code></code><span>the progress bars background color Using CSS Effects.',
    item: [
      {
        value: '30%',
        class: 'progress-bar bg-primary',
